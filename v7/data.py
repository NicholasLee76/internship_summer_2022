...
scroll = Turbo('scroll', 1500, False)
hp1200 = Turbo('hp1200', 1500, False)
hp80_1 = Turbo('hp80_1', 1500, False)
hp300m_1 = Turbo('hp300m_1', 1500, False)
hp700_1 = Turbo('hp700_1', 1500, False)
hp700_2 = Turbo('hp700_2', 1500, False)
hp700_3 = Turbo('hp700_3', 1500, False)
hp80_3 = Turbo('hp80_3', 1500, False)
cryo = Cryo('cryo', 50, False)
...
v7 = Edge(backup, hp700_2, 'v7', True)
...
pumps = [scroll, hp1200, hp80_1, hp80_3, hp300m_1, hp700_1, hp700_2, hp700_3, cryo]
